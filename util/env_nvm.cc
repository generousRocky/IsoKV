...
static void TestKillRandom(int odds, const std::string& srcfile, int srcline)
{
...
int NVMEnv::UnSchedule(void* arg, Priority pri)
{
    return thread_pools_[pri].UnSchedule(arg);
}

unsigned int NVMEnv::GetThreadPoolQueueLen(Priority pri) const
{
    assert(pri >= Priority::LOW && pri <= Priority::HIGH);
...
void NVMEnv::StartThread(void (*function)(void* arg), void* arg)
{
    pthread_t t;
