...
CFLAGS += -g -fPIC ${EXTRA_CFLAGS}
CXXFLAGS += -g -fPIC ${EXTRA_CXXFLAGS}
...
CFLAGS += $(WARNING_FLAGS) -fPIC -I. -I./include $(PLATFORM_CCFLAGS) $(OPT)
CXXFLAGS += $(WARNING_FLAGS) -fPIC -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT) -Woverloaded-virtual -Wnon-virtual-dtor -Wno-missing-field-initializers
