...
#RBENCH_BLOCK_SIZE=$((64 * KB)) # default: 4k
RBENCH_BLOOM_BITS=10
RBENCH_CACHE_SIZE=$((1 * MB))
#RBENCH_RANDOM_ACCESS_MAX_BUFFER_SIZE=$((128 * MB)) # default: 1MB
#RBENCH_WRITABLE_FILE_MAX_BUFFER_SIZE=$((128 * MB)) # default: 1MB
#RBENCH_WRITE_BUFFER_SIZE=$((2000 * MB)) # default: 64MB
RBENCH_MAX_WRITE_BUFFER_NUMBER=2
RBENCH_MIN_WRITE_BUFFER_NUMBER_TO_MERGE=1
RBENCH_TARGET_FILE_SIZE_MULTIPLIER=1
#RBENCH_TARGET_FILE_SIZE_BASE=$((2000 * MB)) # default: 64MB
#RBENCH_MAX_BYTES_FOR_LEVEL_BASE=$((4000 * MB)) # default: 256MB
RBENCH_CACHE_NUMSHARDBITS=4
RBENCH_COMPRESSION_RATIO=1 # default: 0.5
RBENCH_COMPRESSION_TYPE=none
RBENCH_DELETE_OBSOLETE_FILES_PERIOD_MICROS=300000000
#RBENCH_DISABLE_SEEK_COMPACTION=1 #default: 0
RBENCH_DISABLE_WAL=1
#RBENCH_LEVEL0_FILE_NUM_COMPACTION_TRIGGER=1 # default: 4
#RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=8 # default: 20
#RBENCH_LEVEL0_STOP_WRITES_TRIGGER=12 # default: 36
RBENCH_MAX_BACKGROUND_COMPACTIONS=20
#RBENCH_MIN_LEVEL_TO_COMPRESS=2 # default: -1(compress all level)
RBENCH_MMAP_READ=1 # default: false
RBENCH_NUM_LEVELS=6 # default: 7
RBENCH_OPEN_FILES=500000
RBENCH_STATISTICS=1
#RBENCH_STATS_INTERVAL=100000 # defalut: 0
#RBENCH_STATS_PER_INTERVAL=1 # default: 0
RBENCH_SYNC=0
RBENCH_THREADS=1
