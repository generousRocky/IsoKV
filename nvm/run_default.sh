...
RBENCH_BIN="../db_bench"
RBENCH_NUM=524288 #187500 #187500 #375000 #750000 #1500000
RBENCH_VALUE_SIZE=$((16 * KB))
RBENCH_BLOCK_SIZE=$((64* KB))
RBENCH_BLOOM_BITS=-1
RBENCH_CACHE_SIZE=$((8 * MB))
...
RBENCH_DISABLE_WAL=false
RBENCH_LEVEL0_FILE_NUM_COMPACTION_TRIGGER=4
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=20 #20
RBENCH_LEVEL0_STOP_WRITES_TRIGGER=36 #36
RBENCH_MAX_BACKGROUND_COMPACTIONS=20
RBENCH_MAX_BACKGROUND_FLUSHES=2 #2 #4
RBENCH_MIN_LEVEL_TO_COMPRESS=2
RBENCH_MMAP_READ=0
RBENCH_NUM_LEVELS=6
RBENCH_OPEN_FILES=500000
RBENCH_STATISTICS=1
RBENCH_STATS_INTERVAL=0
RBENCH_STATS_PER_INTERVAL=1
RBENCH_REPORT_INTERVAL_SECONDS=10
RBENCH_SYNC=0
