...
#RBENCH_BENCHMARKS="fillseq,stats"
...
RBENCH_WRITABLE_FILE_MAX_BUFFER_SIZE=$((128 * MB)) # 1GB
RBENCH_WRITE_BUFFER_SIZE=$((64 * MB))
RBENCH_MAX_WRITE_BUFFER_NUMBER=2
RBENCH_MIN_WRITE_BUFFER_NUMBER_TO_MERGE=1
RBENCH_TARGET_FILE_SIZE_MULTIPLIER=1 #1
RBENCH_MAX_BYTES_FOR_LEVEL_MULTIPLIER=10 #10
RBENCH_TARGET_FILE_SIZE_BASE=$((64 * MB)) # 64
RBENCH_MAX_BYTES_FOR_LEVEL_BASE=$((256 * MB)) # 256
...
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=8 #20
RBENCH_LEVEL0_STOP_WRITES_TRIGGER=12 #36
RBENCH_MAX_BACKGROUND_COMPACTIONS=1
RBENCH_MAX_BACKGROUND_FLUSHES=1
RBENCH_MIN_LEVEL_TO_COMPRESS=2
RBENCH_MMAP_READ=0
RBENCH_NUM_LEVELS=6
RBENCH_OPEN_FILES=500000
RBENCH_STATISTICS=1
RBENCH_STATS_INTERVAL=10000
...
#RBENCH_CMD_PREFIX="valgrind"
RBENCH_BIN="../db_bench"
RBENCH_NUM=600000 #187500 #187500 #375000 #750000 #1500000
RBENCH_VALUE_SIZE=$((16 * KB))
RBENCH_BLOCK_SIZE=$((64 * KB))
RBENCH_BLOOM_BITS=10
RBENCH_CACHE_SIZE=$((1 * MB))
RBENCH_RANDOM_ACCESS_MAX_BUFFER_SIZE=$((1 * MB))
RBENCH_WRITABLE_FILE_MAX_BUFFER_SIZE=$((1 * MB))
RBENCH_WRITE_BUFFER_SIZE=$((64 * MB))
RBENCH_MAX_WRITE_BUFFER_NUMBER=2
RBENCH_MIN_WRITE_BUFFER_NUMBER_TO_MERGE=1
RBENCH_TARGET_FILE_SIZE_MULTIPLIER=1 #1
RBENCH_MAX_BYTES_FOR_LEVEL_MULTIPLIER=2 #10
RBENCH_TARGET_FILE_SIZE_BASE=$((4 * MB)) # 64
RBENCH_MAX_BYTES_FOR_LEVEL_BASE=$((64 * MB)) # 256
RBENCH_CACHE_NUMSHARDBITS=4
RBENCH_COMPRESSION_RATIO=1
RBENCH_COMPRESSION_TYPE=none
RBENCH_DELETE_OBSOLETE_FILES_PERIOD_MICROS=300000000
...
RBENCH_DISABLE_WAL=0
RBENCH_LEVEL0_FILE_NUM_COMPACTION_TRIGGER=1
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=20 #8
RBENCH_LEVEL0_STOP_WRITES_TRIGGER=36 #12
...
RBENCH_STATISTICS=1
RBENCH_STATS_INTERVAL=10000
#RBENCH_STATS_INTERVAL=1000000
RBENCH_STATS_PER_INTERVAL=1
RBENCH_SYNC=0
RBENCH_READWRITEPERCENT=50
RBENCH_THREADS=1
#RBENCH_THREADS=$(nproc)
RBENCH_VERIFY_CHECKSUM=1
