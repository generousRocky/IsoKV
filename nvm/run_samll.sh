...
RBENCH_BENCHMARKS="updaterandom,stats"
RBENCH_DEV_MODE="nvm"
...
RBENCH_BIN="../db_bench"
RBENCH_NUM=10000000
RBENCH_VALUE_SIZE=$((1 * KB))
RBENCH_BLOCK_SIZE=$((4 * KB))
RBENCH_BLOOM_BITS=-1
...
RBENCH_TARGET_FILE_SIZE_BASE=$((64 * GB))
RBENCH_MAX_BYTES_FOR_LEVEL_BASE=$((256 * GB))
RBENCH_CACHE_NUMSHARDBITS=2
RBENCH_COMPRESSION_RATIO=1
RBENCH_COMPRESSION_TYPE=none
RBENCH_DELETE_OBSOLETE_FILES_PERIOD_MICROS=0
RBENCH_DISABLE_SEEK_COMPACTION=0
RBENCH_DISABLE_WAL=0
RBENCH_LEVEL0_FILE_NUM_COMPACTION_TRIGGER=4 # 4
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=20
RBENCH_LEVEL1_STOP_WRITES_TRIGGER=36
...
RBENCH_WRITABLE_FILE_MAX_BUFFER_SIZE=$((1 * GB)) # 1GB
RBENCH_WRITE_BUFFER_SIZE=$((2 * GB)) # 이 크기가 넘어가면 써짐
RBENCH_MAX_WRITE_BUFFER_NUMBER=5
RBENCH_MIN_WRITE_BUFFER_NUMBER_TO_MERGE=1
RBENCH_TARGET_FILE_SIZE_MULTIPLIER=1 #1
RBENCH_MAX_BYTES_FOR_LEVEL_MULTIPLIER=2 #10
RBENCH_TARGET_FILE_SIZE_BASE=$((1 * GB))
...
RBENCH_LEVEL0_SLOWDOWN_WRITES_TRIGGER=8 #8
RBENCH_LEVEL0_STOP_WRITES_TRIGGER=12 #12
